...
exports.request = function(options, callback) {
  ...
  var uri = oauth.fillURL(options.path, options.host, options.port, false /*options.secure*/);
...
exports.signRequest = function(method, path, headers, body, signature) {
  var auth = {
...
exports.timestamp = function() {
	return (new Date().getTime() / 1000) | 0; // faster truncation
};
