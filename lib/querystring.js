...
// I had to patch the main querystring class to support overriding
// the escape method used inside of the stringify.  I simply changed the scope
// of the call.
...
QueryString.stringify = QueryString.encode = function (obj, sep, eq, munge, name) {
  ...
  if (obj == null || typeof obj == "function") {
    return name ? this.escape(name) + eq : "";
  }
  ...
  if (isNumber(obj) || isString(obj)) {
    return this.escape(name) + eq + this.escape(obj);
  }
  if (isA(obj, [])) {
    name = name + (munge ? "[]" : "");
